 ...
 * o erro aparece no primeiro minuto, não na primeira alocação de morador.
 *
 * O token é de vida curta e traz quem chamou. Não substitui a sessão do usuário: ele diz
 * "este pedido veio do Alojamentos", não "este pedido é do fulano".
 */
 ...
 * serviria como credencial de máquina, e um endereço pensado para o alojamentos passaria a
