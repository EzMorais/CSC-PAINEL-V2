 ...
 * migracao-go/README.md. Módulo Alojamentos, montado sob /alojamentos no mesmo processo que
 * a identidade (antigo Portal), o Painel de Locação, o RH/SST e o Almoxarifado.
 */
process.env.ALVO_E2E = 'go'

const PORTA = Number(process.env.PORTA_E2E_GO ?? 3304)
