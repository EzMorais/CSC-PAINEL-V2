 ...
 * migracao-go/README.md. Módulo Almoxarifado, montado sob /almoxarifado no mesmo processo
 * que a identidade (antigo Portal) e o Painel de Locação.
 */
process.env.ALVO_E2E = 'go'

const PORTA = Number(process.env.PORTA_E2E_GO ?? 3302)
