 ...
 * migracao-go/README.md. Módulo RH e SST, montado sob /rh no mesmo processo que a
 * identidade (antigo Portal), o Painel de Locação e o Almoxarifado.
 */
process.env.ALVO_E2E = 'go'

const PORTA = Number(process.env.PORTA_E2E_GO ?? 3303)
