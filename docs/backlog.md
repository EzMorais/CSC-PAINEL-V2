...
Tarefas ordenadas para tirar o [DEPLOY.md](DEPLOY.md) do papel e colocar as 9 aplicações no
...
- [ ] [2. Configurar DNS](https://github.com/EzMorais/CSC-PAINEL/issues/2) — um registro A (`sistemas`) apontando pro IP do VPS. Frota deixou de ter subdomínio próprio em 2026-08-11. (DEPLOY.md Passo 1)
...
- [ ] [7. Preencher o `.env.production` de cada app + gerar o `AUTH_SECRET` compartilhado](https://github.com/EzMorais/CSC-PAINEL/issues/7) — mesmo valor em portal, painel-locação, rh, estoque, programação, alojamentos, frota, whatsapp e migracao-go. (Passo 5.1–5.2)
- [ ] [8. Configurar o Frota](https://github.com/EzMorais/CSC-PAINEL/issues/8) — desde 2026-08-11 usa o mesmo `AUTH_SECRET` compartilhado do item 7 (não tem mais segredo/login próprios); nada de configuração extra além do que já foi preenchido lá.
- [ ] [9. (Opcional) Configurar a chave do Google Maps](https://github.com/EzMorais/CSC-PAINEL/issues/9) — autocompletar de endereço nos Alojamentos. (Passo 5.3)
...
- [ ] [11. Emitir o primeiro certificado HTTPS](https://github.com/EzMorais/CSC-PAINEL/issues/11) — nginx bootstrap + certbot, cobrindo `sistemas.SEUDOMINIO.com.br`. (Passo 7)
...
- [ ] [13. Testar o login único (SSO)](https://github.com/EzMorais/CSC-PAINEL/issues/13) — entrar no Portal e confirmar acesso direto a Painel de Locação, RH, Almoxarifado, Programação, Alojamentos e Frota sem novo login.
- [ ] [14. Testar o WhatsApp isoladamente](https://github.com/EzMorais/CSC-PAINEL/issues/14) — parear o número e confirmar que os Alojamentos conseguem mandar mensagem.
