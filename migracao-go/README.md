...
| **Programação Diária** (`/programacao`) | ✅ app legado de referência | ✅ gateway → `apps/programacao` | Gateway abre `/dia/2026-08-13`; handlers Go estão despublicados | ✅ legado ativo |
